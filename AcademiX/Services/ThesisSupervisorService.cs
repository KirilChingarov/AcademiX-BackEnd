...
namespace AcademiX.Services
{
	public class ThesisSupervisorService : IThesisSupervisorService
	{
		...
		public void CreateThesisSupervisor(ThesisSupervisor thesisSupervisor)
		{
			...
			/*if (_repository.GetThesisSupervisorByUsername(thesisSupervisor.Username) != null)
			{
		...
		{
			throw new DuplicateEntityException("Supervisor with this username is already created.");
		}*/
		}
